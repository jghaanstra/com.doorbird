...
exports.updateNotifications = function (homeyaddress, callback) {
  ...
  Object.keys(doorbirds).forEach(function(key) {
    ...
    var optionsdoorbell = {
      url: "http://"+ address +"/bha-api/favorites.cgi?action=save&type=http&title=Homey%20Doorbell%20Trigger&value="+ doorbellurl +"&id=1000",
      auth: {
        user: username,
        pass: password
      },
    ...
    var optionsmotion = {
      url: "http://"+ address +"/bha-api/favorites.cgi?action=save&type=http&title=Homey%20Motion%20Trigger&value="+ motionurl +"&id=1001",
      auth: {
        user: username,
        pass: password
      },
    ...
    var optionsdooropen = {
      url: "http://"+ address +"/bha-api/favorites.cgi?action=save&type=http&title=Homey%20Relay%20Trigger&value="+ dooropenurl +"&id=1002",
      auth: {
        user: username,
        pass: password
      },
...
exports.scheduleRelay = function (homeyaddress, callback) {
  const doorbirds = Homey.ManagerDrivers.getDriver('doorbird').getDevices();
  ...
  Object.keys(doorbirds).forEach(function(key) {
    ...
    var optionsrelay = {
      url: "http://"+ address +"/bha-api/schedule.cgi",
      method: "POST",
      json: requestData,
      auth: {
        user: username,
    ...
    callback(false, "Relay has been scheduled ...");
