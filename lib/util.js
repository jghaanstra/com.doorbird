      ...
      try {
        ...
        if (action == 'remove') {
          ...
          relays.forEach(async (relay) => {
            number++;
            let endpoint = '/bha-api/favorites.cgi?action=save&type=http&title=Homey%20Relay%20'+ relay +'%20Trigger&value=http://'+ homeyaddress +'/api/app/com.doorbird/event/relays/' + mac + '/'+ relay +'&id='+ number;
